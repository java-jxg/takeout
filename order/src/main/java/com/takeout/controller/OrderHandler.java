...
import com.takeout.entity.OrderVO;
...
public class OrderHandler {
    ...
    public List<Order> findAllByUid(@PathVariable("uid") long uid, @PathVariable("page") int page, @PathVariable("limit") int limit){
        return orderRepository.findAllByUid(uid,(page-1)*limit,limit);
    }
